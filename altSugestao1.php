...
try {
	...
	echo "<table border=1><tr><td>ID</td><td>Descrição</td><td>Abrev</td><td></td><td></td></tr>"; //Inicia tabela e escreve cabecalho
	foreach($result as $row) { // escreve n linhas
		...
		echo "<td>"  .  $row[ "DS_ABREV"]. "</td>";
  		echo "<td>"  .  "<a href='altSugestao2.php?id=".$row["ID_SUGESTAO"]."'>Alterar</a>"  .  "</td>";
