...
$pass = '';
    ...
    $dbh->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		...
		echo "<table border=1><tr><td>ID</td><td>Descrição</td><td>Abrev</td><td>Valor KG</td><td></td></tr>"; //Inicia tabela e escreve cabecalho
		foreach($result as $row) { // escreve n linhas
			...
			echo "<td>"  .  "<a href='altCorte2.php?id=".$row["ID_CORTE"]."'>Alterar</a>"  .  "</td>";
